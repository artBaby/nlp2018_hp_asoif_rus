...
def print_latex_version(results, method, FILTER_SECTIONS, result_file):
    """
    ...
    result_file.write('Number of tasks:       &' + " & ".join(counts) + " \\\\ \hline\n ")
    # print(method, "               & ", " & ".join(vals) , " \\\\ ")
    result_file.write(method + "              & " + " & ".join(vals) + " \\\\ \n\n\n\n")
