...
def create_questions():
    ...
    create_dataset(sourcefile="./datasets/soiaf_analogies_rus.txt",          outfile="./datasets/questions_soiaf_analogies_rus.txt",   mode="analogies")
    create_dataset(sourcefile="./datasets/soiaf_doesnt_match_rus.txt",       outfile="./datasets/questions_soiaf_doesnt_match_rus.txt", mode="doesnt_match")
    ...
    create_dataset(sourcefile="./datasets/hp_analogies_rus.txt",          outfile="./datasets/questions_hp_analogies_rus.txt",   mode="analogies")
    create_dataset(sourcefile="./datasets/hp_doesnt_match_rus.txt",       outfile="./datasets/questions_hp_doesnt_match_rus.txt", mode="doesnt_match")
